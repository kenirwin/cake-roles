...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Role'), ['action' => 'edit', $role->woman_id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Role'), ['action' => 'delete', $role->woman_id], ['confirm' => __('Are you sure you want to delete # {0}?', $role->woman_id)]) ?> </li>
